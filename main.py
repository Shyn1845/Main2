...
from PyQt5.QtWidgets import QApplication, QWidget, QListWidget, QLabel, QPushButton, QHBoxLayout, QVBoxLayout, QFileDialog, QMessageBox
...
'''btn_sharp.clicked.connect(workimg.do_sharpen)'''
mw.show()
app.exec_()
